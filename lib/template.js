 ...
 * @param template The json object for the template. The template variable syntax is {name=defaultValue:type}.
...
JsonTemplate.prototype.compile = function() {
    ...
    var schema = {};
    traverse(this.template).forEach(function (item) {
        var match = null;
