...
/**
 * Set the flag whether to response headers
 * @param {boolean} responseHeaders A flag to indicate whether or not response headers
 * @returns {RequestBuilder}
 */
RequestBuilder.prototype.responseHeaders = function(responseHeaders) {
  this.template.template.responseHeaders = responseHeaders;
  return this;
};
  ...
  if (cb) {
    callback = function(err, response, body) {
      if (err) {
        ...
        if (self.template.template.responseHeaders) {
          result = {
