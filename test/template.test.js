...
describe('JsonTemplate', function() {
  describe('Request templating', function() {
    describe('build()', function() {
      ...
      it('should not fail given symbols', function(done) {
        const symbol = Symbol('agent');
        const obj = {
          url: 'http://localhost:3000/test',
          options: {
            [symbol]: {
        ...
        const template = new JsonTemplate(obj);
        (template.build(template)).should.not.throw();
        done();
      });

      it('should ignore symbols', function(done) {
        const symbol = Symbol('agent');
        const obj = {
          url: 'http://localhost:3000/test',
          options: {
    ...
    describe('compile()', function() {
      it('should not fail given symbols', function(done) {
        ...
        const template = new JsonTemplate(obj);
        (template.compile(template)).should.not.throw();
        done();
      });
    });
  });
